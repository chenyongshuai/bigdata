...
/** @author:  v_chenyongshuai@:
  ...
  * @describe:   生成Hive建表语句
  */
public class GenerateCreateTableHiveQL {
	public static void main(String[] args) throws IOException {
		File file = new File("C:/Users/chenys/Desktop/work/数据标准化/imap/imap主数据OTD-oracle.txt");
		...
		for (String onesql : ss) {
			...
			File f = new File("C:/Users/chenys/Desktop/work/数据标准化/imap/imap主数据OTD-hive.txt");
